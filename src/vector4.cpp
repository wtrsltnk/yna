...
float & Vector4::operator[](int i) { assert(i >= 0 && i < 4); return (&X)[i]; }
float Vector4::operator[](int i) const { assert(i >= 0 && i < 4); return (&X)[i]; }
bool Vector4::operator == (const Vector4& v) const { return this->X == v.X && this->Y == v.Y && this->Z == v.Z && this->W == v.W; }
bool Vector4::operator != (const Vector4& v) const { return this->X != v.X || this->Y != v.Y || this->Z != v.Z || this->W != v.W; }
Vector4& Vector4::operator  = (const Vector4& v) { this->X  = v.X; this->Y  = v.Y; this->Z  = v.Z; this->W  = v.W; return *this; }
Vector4& Vector4::operator += (const Vector4& v) { this->X += v.X; this->Y += v.Y; this->Z += v.Z; this->W += v.W; return *this; }
Vector4& Vector4::operator -= (const Vector4& v) { this->X -= v.X; this->Y -= v.Y; this->Z -= v.Z; this->W -= v.W; return *this; }
Vector4& Vector4::operator *= (const Vector4& v) { this->X *= v.X; this->Y *= v.Y; this->Z *= v.Z; this->W *= v.W; return *this; }
Vector4& Vector4::operator /= (const Vector4& v) { this->X /= v.X; this->Y /= v.Y; this->Z /= v.Z; this->W /= v.W; return *this; }
Vector4& Vector4::operator  = (float s) { this->X  = s; this->Y  = s; this->Z  = s; this->W  = s; return *this; }
Vector4& Vector4::operator += (float s) { this->X += s; this->Y += s; this->Z += s; this->W += s; return *this; }
Vector4& Vector4::operator -= (float s) { this->X -= s; this->Y -= s; this->Z -= s; this->W -= s; return *this; }
Vector4& Vector4::operator *= (float s) { this->X *= s; this->Y *= s; this->Z *= s; this->W *= s; return *this; }
Vector4& Vector4::operator /= (float s) { this->X /= s; this->Y /= s; this->Z /= s; this->W /= s; return *this; }
