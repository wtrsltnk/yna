...
getref_property<Vector2> Vector2::One =
    getref_property<Vector2>([]() -> const Vector2 & {
...
Vector2 Vector2::TransformNormal(
    const Vector2 &v,
    const class Matrix &m)
{
    return Vector2();
